...
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/jmcc0nn3ll/jetty-antora-ui
:url-preview:
// External URLs:
...
This project is a fork and customization of the antora-default-ui project that produces a UI bundle that can be used by {url-antora}[Antora] to generate the Eclipse Jetty documentation and website.
